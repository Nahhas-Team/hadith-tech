...
const Episodes = () => {
  return (
    <div className="container relative">
      ...
      <div className="grid md:grid-cols-2 gap-6 md:max-w-[1000px] max-w-[450px] mx-auto my-8">
        {LastEpisodes.map((item, index) => (
          <div className="border p-5 rounded-3xl" key={index}>
            <div className="flex mb-2 items-center justify-start gap-1">
      ...
      <div className="bg-gradient-to-t from-background to-transparent absolute bottom-8 left-1/2 -translate-x-1/2 pt-16 h-24 w-full">
